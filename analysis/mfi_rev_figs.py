...
box(3.2,1.1,4.4,0.8,"Exploratory fulfilment-model subset\nn = 75",fc="#E8F6F0",ec=GREEN,fs=8.0)
...
ax.set_ylabel("Life Restoration score (0-100)")
...
ax.set_title("Figure 3. Diary headache-day proportion and Life Restoration score",fontsize=9.6,loc="left",weight="bold")
ax.spines[['top','right']].set_visible(False)
plt.tight_layout(); plt.savefig("fig3_proportion_restoration.png",bbox_inches="tight"); plt.close()
...
axs.set_xlabel("Diary headache-day proportion"); axs.set_ylabel("Life Restoration score")
...
print("wrote fig1_flow.png, fig2_loadings.png, fig3_proportion_restoration.png, figS1_discordance.png")
